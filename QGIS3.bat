...
XCOPY \\100.100.100.100\bd_sig\z_QGIS\Formations\tests_oslandia_b\default %APPDATA%\QGIS\QGIS3\profiles\default\ /s /e /y>>\\100.100.100.100\users\tlaveille\logQGIS3\log%USERNAME%.txt
